...
The `git config` is used to set the configuration values on a local, global or system level. A local level is a default setting if the level option is not entered.
<br/><br/>
